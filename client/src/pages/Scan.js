...
export default function Scan() {
  ...
  const gethostscan = async () => {
    ...
    axios
      .get(`http://app.dockysec.xyz:5000/host-result?id=${id}`)
      .then((response) => {
  ...
  const getcontainerscan = async () => {
    ...
    axios
      .get(`http://app.dockysec.xyz:5000/container-result?id=${id}`)
      .then((response) => {
        console.log(response.data);
  ...
  const getBechmark = async () => {
    ...
    axios
      .get(`http://app.dockysec.xyz:5000/get-benchmark?id=${id}`)
      .then((response) => {
        console.log(response.data);
